...
def splash_screen():
    ...
    titlemsg2 = font_splash_credit.render("Made by GameJunkies", True, (0, 255, 255))
...
def end_screen():
    ...
    WIN.blit(endmsg, (50, 100 + 20*math.sin(time.time())))
    scoremsg = font_end2.render("Your score: "+str(final_score), True, (0, 255, 255))
    WIN.blit(scoremsg, (350, 250))
...
ingame_font = py.font.Font('Resources/newfont.otf', 35)
...
def show_time():
    score = font_time.render(str(12*int(time.time()-current_time)), True, (255, 255, 255))
    WIN.blit(score, (55, 15))
...
hydrodisplay_norm = font_hydro.render("HYDRATION", True, (0,0,0))
hydrodisplay_warn = font_hydro.render("HYDRATION", True, (255,255,255))
...
while running:
    ...
    if is_mainscreen == True:
        ...
        if hydrometer.current_health <= 75:
            ...
            WIN.blit(hydrodisplay_norm, (67, 630))
            warning_red = False

        if hydrometer.current_health <=0:
            is_mainscreen = False
            is_endscreen = True
            final_score = 12*timestamp_main
            warning_red = False
